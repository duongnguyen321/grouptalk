...
```markdown
WRONG: "What authentication method?"
RIGHT: "Should users sign up with email/password or social login?
...
```markdown
WRONG: "User probably wants Stripe for payments"
RIGHT: "Which payment provider fits your needs?
