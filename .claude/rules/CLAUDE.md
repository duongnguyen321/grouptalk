...
**Output:** `plans/PLAN-{index}-{task-slug}.md`
...
|--------------|---------------|--------|
| **NATIVE APP** (React Native, Expo) | `frontend-specialist` | mobile-design |
...
|------------|---------|---------|
| **Manual Audit** | `python .claude/hooks/checklist.py .` | Priority-based project audit |
| **Pre-Deploy** | `python .claude/hooks/verify_all.py . --url <URL>` | Full Suite + Performance + E2E |
...
| Task | Read |
|------|------|
| Web / Native UI/UX | `.claude/agents/frontend-specialist.md` |
